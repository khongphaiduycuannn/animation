...
public class StickerView extends FrameLayout {
    ...
    private Sticker previousSticker;

    private boolean locked;
    private boolean constrained;

    private OnStickerOperationListener onStickerOperationListener;
    private OnTouchOutsideListener onTouchOutsideListener = (pre) -> {
    };
    ...
    protected boolean onTouchDown(@NonNull MotionEvent event) {
        ...
        if (currentIcon != null) {
            ...
            previousSticker = handlingSticker;
        ...
        if (currentIcon == null && handlingSticker == null) {
            onTouchOutsideListener.onTouch(previousSticker);
            return false;
        }
        invalidate();
        return true;
    ...
    public interface OnTouchOutsideListener {
        void onTouch(@Nullable Sticker previousSticker);
    }
}
